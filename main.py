...
# # listener=sr.Recognizer()   #to recognize the voice
# # engine=pyttsx3.init()
# # voices = engine.getProperty('voices')
# # engine.setProperty('voice',voices[1].id)
...
# #     engine.runAndWait()
# # try:
# #     with sr.Microphone() as source: #to get the speech what we  speak
# #         print('listening....')
# #         voice=listener.listen(source)   #it listens the voice
# #         command=listener.recognize_google(voice)
